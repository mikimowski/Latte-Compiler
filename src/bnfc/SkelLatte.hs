...
transTopDef x = case x of
  ...
  TopFuncDef _ funcdef -> failure x
transFuncDef :: Show a => FuncDef a -> Result
transFuncDef x = case x of
  FuncDef _ type_ ident args block -> failure x
...
transClassMember x = case x of
  ClassField _ type_ ident -> failure x
  ClassMethod _ funcdef -> failure x
transClassDef :: Show a => ClassDef a -> Result
transClassDef x = case x of
  ClassDef _ ident classmembers -> failure x
  ClassExtDef _ ident1 ident2 classmembers -> failure x
...
transExpr x = case x of
  ...
  EArrGet _ expr1 expr2 -> failure x
